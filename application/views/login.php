        ...
        <div class="container py-5 h-100">
            <div class="row d-flex align-items-center justify-content-center h-100">
                <div class="col-md-8 col-lg-7 col-xl-6">
                    <img src="<?= base_url()?>assets/images/login.png" class="img-fluid" alt="Logo" height="300px"
                        width="600px">
                </div>
                <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                    <form action='<?= base_url() ?>login/Auth' method="post">
                        ...
                        <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                            <button class="btn btn-lg text-light my-2 py-3"
                                style="width:100% ; border-radius: 30px; font-weight:600; background-color:aqua"
                                type="submit">Login</button>
                        </div>

                    </form><br>
                    <p align="center">i don't have any account <a href='<?= base_url() ?>index.php/Dashboard/register'
                            style="font-weight:600;text-decoration:none;text-color: blue">Register Here</a></p>
                </div>
            </div>
        </div>
    </section>
