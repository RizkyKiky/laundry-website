                        ...
                        <div class="card-body p-md-2">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form class="mx-1 mx-md-4" action="<?= site_url()?>/Auth/register" method="post">
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="text" id="form3Example1c"
                                                    class="form-control form-control-lg py-3" name="name"
                                        ...
                                        <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                            <input type="submit" value="Register" name="register"
                                                ...
                                                style="width:100% ; border-radius: 30px; font-weight:600;background-color:aqua"
                                                style="border-radius:25px ;" />

                                        </div>

                                    </form>
                                    <p align="center">i have already account <a
                                            href='<?= base_url() ?>index.php/Dashboard/login'
                                            style="font-weight:600; text-decoration:none;text-color:blue">Login</a></p>
                                </div>
                                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">

                                    <img src='<?= base_url() ?>assets/images/register.png' class="img-fluid"
                                        alt="Sample image" height="300px" width="500px">
